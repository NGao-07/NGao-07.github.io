...
const cvData = {
    personalInfo: {
        ...
        `, // Detailed about section, research interests will be appended here by script
        researchInterests: [
        ...
        pictureUrl: "assets/my_photo.jpg", // 替换为你的照片路径
        ...
        socialLinks: [ // For Footer and Contact section
            { name: "Email", icon: "fas fa-envelope", url: "mailto:gn8022@mail.ustc.edu.cn" },
            { name: "Google Scholar", icon: "fas fa-graduation-cap", url: "#" }, // 替换为你的链接
            { name: "LinkedIn", icon: "fab fa-linkedin", url: "#" },         // 替换为你的链接
            { name: "GitHub", icon: "fab fa-github", url: "#" }              // 替换为你的链接
        ]
    },
    navigation: [ // For header navigation
        { name: "Home", id: "hero" },
        { name: "About", id: "about" },
        { name: "Research", id: "research-experience" }, // Link to research experience
    ...
    researchExperience: [ // Used for "Research Experience/Projects" section
    ...
    publications: {
        ...
        conferenceAbstracts: [
            ...
            // Add other conference abstracts here...
        ],
        patents: [
    ...
    skills: [ // Simplified for this template, will be displayed as tags or list
    ...
    notepadContent: `
        <p class="mb-4">This is a space for my current thoughts, brief notes on interesting papers, or emerging ideas in Medical Physics and AI. Content is evolving.</p>
        <h4 class="text-lg font-semibold mb-2">Recent thought:</h4>
        <p class="italic">"The synergy between advanced radiation detectors and sophisticated AI algorithms holds immense promise for truly personalized and adaptive radiotherapy. Exploring real-time feedback loops is a key interest."</p>
    `,
    logoText: "Ning GAO" // For header and footer
};